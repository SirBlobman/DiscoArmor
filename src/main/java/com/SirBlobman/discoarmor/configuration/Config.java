...
public class Config {
	private static final File FOLDER = DiscoArmor.FOLDER;
	
	/**
	 * Loads a configuration file
	 * 
	 * @param fileName The name of the file which is inside of "/plugins/DiscoArmor/"
	 ...
	 * @param fileName The name of the file in "/plugins/DiscoArmor/"
	 */
	...
	/**
	 * This will copy a file in the jar file for this plugin to "/plugins/DiscoArmor/"<br/>
	...
	public static void copyFromJar(String fileName) {
		try {
			JavaPlugin pl = DiscoArmor.INSTANCE;
